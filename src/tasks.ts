...
function createTask(
  ...
  return {
    ...
    parent: (created as any).parent || null,
  };
}
...
function updateTask(
  ...
  if (fields.due !== undefined && fields.due !== "")
    patch.due = new Date(fields.due).toISOString();
...
function completeTask(
  ...
  const updated = Tasks.Tasks!.patch(
    { status: "completed" },
    taskListId,
    taskId,
  );
